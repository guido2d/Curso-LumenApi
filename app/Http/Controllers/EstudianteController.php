...
class EstudianteController extends Controller
{
    ...
    public function update(Request $request, $estudiante_id){
        ...
        return $this->crearRespuestaError("El id no corresponde a un estudiante", 400);
    }
    ...
    public function destroy($estudiante_id){
        ...
        return $this->crearRespuestaError('No existe el estudiante con el id especificado', 404);
    }
    ...
    public function validacion($request){
        $reglas = [
            ...
            'carrera' => 'required|in:ingeniería,matemática,fisica',
        ];
